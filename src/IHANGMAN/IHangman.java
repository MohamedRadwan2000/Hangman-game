...
public interface IHangman {
     ...
     *  * @param c * case insensitive user guess. * If c is NULL then ignore it and do no change
     *  * @return
     *  * secret word with the remaining hidden characters (use ’-’ instead * of unsolved characters), or return NULL if user reached max wrong
     *  * guesses. */
